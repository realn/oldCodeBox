...
namespace GL{
	...
	enum VERSION_3_2_64BIT_TOKENS : uint64 {
	...
	enum EXT_CORE_GEN_MIPMAP_TOKENS {
...
namespace WGL{
	enum PBUFFER_TOKENS {
		WGL_DRAW_TO_PBUFFER            = 0x202D,
		WGL_MAX_PBUFFER_PIXELS         = 0x202E,
		WGL_MAX_PBUFFER_WIDTH          = 0x202F,
		WGL_MAX_PBUFFER_HEIGHT         = 0x2030,
		WGL_PBUFFER_LARGEST            = 0x2033,
		WGL_PBUFFER_WIDTH              = 0x2034,
		WGL_PBUFFER_HEIGHT             = 0x2035,
		WGL_PBUFFER_LOST               = 0x2036,
	};

	enum PIXEL_FORMAT_TOKENS {
