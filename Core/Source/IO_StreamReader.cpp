...
namespace CB{
	namespace IO{
		...
		void	CStreamReader::Process(int8& Value){
			this->Read(Value);
		}

		void	CStreamReader::Process(int16& Value){
			this->Read(Value);
		}

		void	CStreamReader::Process(int32& Value){
			this->Read(Value);
		}

		void	CStreamReader::Process(int64& Value){
			this->Read(Value);
		}

		void	CStreamReader::Process(float32& Value){
			this->Read(Value);
		}

		void	CStreamReader::Process(float64& Value){
			this->Read(Value);
		}

		void	CStreamReader::Process(uint8& Value){
			this->Read(Value);
		}

		void	CStreamReader::Process(uint16& Value){
			this->Read(Value);
		}

		void	CStreamReader::Process(uint32& Value){
			this->Read(Value);
		}

		void	CStreamReader::Process(uint64& Value){
			this->Read(Value);
		}

		void	CStreamReader::Process(CString& Value){
			this->Read(Value);
		}
